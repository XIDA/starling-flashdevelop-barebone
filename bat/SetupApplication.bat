...
:: Android packaging
set AND_CERT_NAME="Starling-FlashDevelop-Barebone"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\StarlingFlashDevelopBarebone.p12
...
set IOS_PROVISION=cert\StarlingFlashDevelopBarebone.mobileprovision
...
set APP_ID=air.StarlingFlashDevelopBarebone

:: Output packages
set DIST_PATH=dist
set DIST_NAME=StarlingFlashDevelopBarebone
